(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('keycloak-js'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('keycloak-angular', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators', 'keycloak-js', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global['keycloak-angular'] = {}, global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators, global.Keycloak, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,exports, core, http, rxjs, operators, Keycloak_, common) { 'use strict';
...
KeycloakService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: KeycloakService, factory: function (t) { return KeycloakService.ɵfac(t); } });
...
KeycloakBearerInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: KeycloakBearerInterceptor, factory: function (t) { return KeycloakBearerInterceptor.ɵfac(t); } });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(CoreModule, { imports: [ɵngcc1.CommonModule] }); })();
...
KeycloakAngularModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: KeycloakAngularModule });
KeycloakAngularModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function KeycloakAngularModule_Factory(t) { return new (t || KeycloakAngularModule)(); }, imports: [[CoreModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(KeycloakAngularModule, { imports: [CoreModule] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(KeycloakAngularModule, [{
        type: core.NgModule,
        args: [{
                imports: [CoreModule]
            }]
